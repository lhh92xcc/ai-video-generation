...
DEFAULT_REFERENCE_STYLE = (
    "polished flat 2D manhwa/webtoon illustration key art, same cohesive series visual bible across "
    ...
    "flat cel-shaded color blocks, controlled illustrated lighting, restrained harmonious color palette, "
    "clean silhouette and readable intentional focal hierarchy, uncluttered background, professional "
    "webtoon production design, consistent design language for later image-to-video shots, "
    "never photorealistic or photographic"
)
...
DEFAULT_REFERENCE_NEGATIVE_PROMPT = (
    ...
    "photorealistic, photographic, product photograph, realistic skin texture, semi-realistic, "
    "painterly brushwork, glossy 3d render, realistic material rendering, different art style, "
    "style drift, text, subtitles, logo, watermark"
)
...
DEFAULT_VIDEO_NEGATIVE_PROMPT = (
    ...
    "hard zoom, overshoot, photorealistic, photographic, product photograph, realistic skin texture, "
    "semi-realistic, painterly brushwork, glossy 3d render, realistic material rendering, "
    "different art style, style drift, text, subtitles, logo, watermark"
)
...
DEFAULT_VIDEO_PROMPT_SUFFIX = (
    ...
    "2D manhwa series visual bible, clean linework with bold consistent ink weight, "
    "flat cel-shaded surfaces, "
    "illustrated color blocks, stable illustrated lighting, never photographic, preserve "
...
DEFAULT_REFERENCE_QUALITY_GUARDRAIL = (
    ...
    "controlled illustrated lighting and palette, same 2D manhwa art direction, flat cel-shaded "
    "surfaces, no photographic rendering, no style mixing, no text or interface elements."
)
